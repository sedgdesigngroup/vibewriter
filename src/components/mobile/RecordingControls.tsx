    ...
    <div className="flex flex-col items-center gap-4">
      ...
      <div className="flex items-center gap-6">
        {!isRecording ? (
          ...
          <button
            onClick={onStart}
            className="w-32 h-32 rounded-full bg-red-500 hover:bg-red-600 active:bg-red-700
          ...
          <>
            ...
            <button
              onClick={onStop}
              className="w-24 h-24 rounded-full bg-slate-600 hover:bg-slate-500 active:bg-slate-400
